...
export function AuditLogSkeleton() {
  return (
    <div className="flex flex-col gap-4" data-testid="audit-log-skeleton">
        ...
        <table className="w-full">
          <thead>
            <tr className="border-b border-border">
              <th className="text-start p-2"><Skeleton className="h-4 w-28" /></th>
          ...
          <tbody>
            {Array.from({ length: 5 }).map((_, i) => (
              <tr key={i} className="border-b border-border">
                ...
                <td className="p-2"><div className="flex justify-end"><Skeleton className="h-5 w-16" /></div></td>
              </tr>
            ))}
          </tbody>
        </table>
